...
--set imageCredentials.dockeryuuvisorg.username=oktopus \
--set imageCredentials.dockeryuuvisorg.password=Apo2cXmQRZUPX18n
...
--set imageCredentials.yuuvisorg.username=oktopus \
--set imageCredentials.yuuvisorg.password=Apo2cXmQRZUPX18n \
